<?php
class ei_cuadro_personas_sin_ddjj extends gafi_ei_cuadro
{
        public function vista_pdf(toba_vista_pdf $salida)
        {
                $salida->set_nombre_archivo("Reporte de agentes sin DDJJ de horarios vigente (" . date('d/m/Y') . ").pdf");
                $salida->titulo("Estado de Declaraciones Juradas de Horario");
                $salida->separacion();
                $salida->separacion();
                $salida->separacion();
