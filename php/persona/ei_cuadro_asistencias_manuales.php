<?php
class ei_cuadro_asistencias_manuales extends gafi_ei_cuadro
{
    public function vista_pdf(toba_vista_pdf $salida)
    {
        $salida->set_nombre_archivo("Reporte de Asistencias Justificadas.pdf");
        $salida->titulo("Reporte de Asistencias Justificadas");
        $salida->separacion();
        $salida->separacion();
        $salida->separacion();
